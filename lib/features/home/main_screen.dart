          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(1, Icons.menu_book_rounded,
                  Icons.menu_book_outlined, labels[1], isDark),
              _buildNavItem(2, Icons.analytics_rounded,
                  Icons.analytics_outlined, labels[2], isDark),
              _buildNavItem(3, Icons.shopping_bag_rounded,
                  Icons.shopping_bag_outlined, labels[3], isDark,
                  badge: AppStateProvider.of(context).cartItemCount),
